...
#MAKE THE PYGAME DISPLAY ON WHICH OUR PROGRAM WILL RUN
WIDTH=800
...
#MAKING OUR SPOT CLASS WHICH REPRESENT EVERY UNIT SQUARE ON PYGAME DISPLAY
...
#FUNCTION TO MAKE RANDOM BARRIERS
    
def make_random_barriers(start , end , grid , rows , width):
    for row in grid:
        for spot in row:
            value=random.randint(0,2)
            
            if value==2 and spot!=start and spot!=end:
                spot.make_barrier()
...
#FUNCTION TO GIVE THE MOST EFFIECIENT PATH
...
#OUR A STAR PATH FINDING ALGORITHM
        ...
        for event in pygame.event.get():
            ...
            if event.type==pygame.KEYDOWN:
                ...
                if event.key==pygame.K_r:
                    grid=make_random_barriers(start , end , grid , ROWS , width)
    pygame.quit()
